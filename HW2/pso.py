...
class PSO:
    def __init__(self, f, bounds, w, c1, c2, N, max_iter, stagnancy):
        global dim
        ...
        num_iter = 0
        cnt = 0
        while num_iter < max_iter and cnt < stagnancy:
            ...
            print("f", tuple(gbest), '=', gbest_fitness)

        print('-------------------------------------------------')
        print("result:\nf", tuple(gbest), '=', gbest_fitness)
